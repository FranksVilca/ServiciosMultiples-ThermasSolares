    ...
    <div>
      <div className="flex flex-col md:flex-row px-4 py-8">
        <div className="flex-1 p-4 flex flex-col justify-center items-center">
          <div className="text-4xl text-[#73FC49] font-serif flex justify-center">{Textos.title}</div>
          <div className="text-second mt-8 flex items-center justify-center px-20 text-center">{Textos.text}</div>
        </div>
        <div className="flex-1 w-full bg-third rounded-2xl h-96 mx-20"></div>
      </div>
    </div>
  );
};
